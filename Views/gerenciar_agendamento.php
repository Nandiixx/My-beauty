        ...
        <div class="content-grid">
            ...
            <div class="section-card">
                ...
                <form action="Index.php" method="POST">
                    ...
                    <div class="form-group">
                        <label for="servicos_ids">
                            <i data-lucide="scissors"></i>
                            Serviço(s) - Segure Ctrl/Cmd para selecionar múltiplos
                        </label>
                        <select name="servicos_ids[]" id="servicos_ids" required multiple size="5">
                            <?php 
                            if (isset($lista_servicos) && !empty($lista_servicos)):
                                foreach($lista_servicos as $s):
                            ?>
                                <option value="<?php echo htmlspecialchars($s->getId()); ?>">
                                    <?php echo htmlspecialchars($s->getNome()); ?> - R$ <?php echo number_format($s->getPreco(), 2, ',', '.'); ?>
                                </option>
                            <?php 
                                endforeach;
                            else:
