<?php
/**
 * View: Agenda do Profissional
 * Recebe dados processados do AgendamentoController::mostrarAgendaProfissional()
 * 
 * Variáveis esperadas:
 * - $lista_agenda_profissional (array de agendamentos)
 */
...
<head>
    ...
    <title>Minha Agenda - MyBeauty</title>
...
<body>
    ...
    <div class="dashboard-container">
        ...
        <div class="section-card">
            ...
            <?php if (isset($lista_agenda_profissional) && !empty($lista_agenda_profissional)): ?>
                <table class="agendamentos-table">
                    ...
                    <tbody>
                        <?php foreach($lista_agenda_profissional as $a): 
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="Index.php?acao=confirmar&id=<?= $a->id ?>" class="btn btn-success">
                                            <i data-lucide="check-circle"></i>
                                            <span>Concluir</span>
                                        </a>
                                        <a href="Index.php?acao=cancelar&id=<?= $a->id ?>" class="btn btn-danger" onclick="return confirm('Tem certeza que deseja cancelar este agendamento?');">
