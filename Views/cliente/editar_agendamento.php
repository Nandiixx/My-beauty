...
<head>
    ...
    <title>Editar Agendamento - MyBeauty</title>
    ...
    <nav class="navbar">
        <div class="navbar-container">
            ...
            <div class="navbar-actions">
                <a href="Index.php?acao=gerenciar_agendamento_mostrar" class="btn-header btn-header--primary">
    ...
    <div class="dashboard-container">
        ...
        <div class="section-card section-card-centered">
            ...
            <form action="Index.php" method="POST">
                <input type="hidden" name="acao" value="agendamento_atualizar">
                    ...
                    <select name="profissional_id" id="profissional_id" required>
                        ...
                        ?>
                            <option value="<?php echo htmlspecialchars($prof->id); ?>" 
                                    <?php echo ($prof->id == $agendamento->profissional_id) ? 'selected' : ''; ?>>
                ...
                <div class="form-group">
                    ...
                    <select name="servico_id" id="servico_id" required>
                        ...
                        if (isset($lista_servicos) && !empty($lista_servicos)):
                            // Pegar o primeiro ID de serviço do agendamento (com verificação de null/empty)
                            $servico_atual = null;
                            if (!empty($agendamento->servico_ids)) {
                                $servico_ids = explode(',', $agendamento->servico_ids);
                                $servico_atual = $servico_ids[0] ?? null;
                            }
                        ...
                        ?>
                            <option value="<?php echo htmlspecialchars($s->getId()); ?>" 
                                    ...
                                    <?php echo ($s->getId() == $servico_atual) ? 'selected' : ''; ?>>
                ...
                <div class="form-group">
                    ...
                    <input type="datetime-local" 
                           name="dataHora" 
                           id="dataHora" 
                           value="<?php echo formatarDataParaInput($agendamento->data_hora); ?>" 
                           required>
                </div>

                <div class="form-actions">
                    <a href="Index.php?acao=gerenciar_agendamento_mostrar" class="btn-secondary">
                        <i data-lucide="x"></i>
                        <span>Cancelar</span>
                    </a>
