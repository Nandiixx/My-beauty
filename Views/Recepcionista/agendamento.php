<?php
/**
 * View: Página de Agendamento (Recepcionista)
 * Recebe dados processados do AgendamentoController::mostrarAgendamentoRecepcionista()
 * 
 * Variáveis esperadas:
            ...
            <div class="navbar-actions">
                ...
                <div class="navbar-user" onclick="toggleUserMenu()">
                    ...
                    <div class="navbar-user__dropdown">
                        ...
                        <a href="Index.php?acao=agendamento_recepcionista_mostrar" class="navbar-user__dropdown-item">
                            <i data-lucide="calendar-plus"></i>
                            <span>Agendar Serviço</span>
                        </a>
                        <a href="Index.php?acao=funcionario_cadastro_mostrar" class="navbar-user__dropdown-item">
                            <i data-lucide="user-plus"></i>
                            <span>Cadastrar Profissional</span>
                        </a>
        ...
        <div class="content-grid">
            ...
            <div class="section-card">
                ...
                <form action="Index.php" method="POST">
                    <input type="hidden" name="acao" value="agendamento_recepcionista_salvar">
                    ...
                    <div class="form-group">
                        ...
                        <select name="cliente_id" id="cliente_id" required>
                            ...
                            <?php 
                            if (isset($lista_clientes) && !empty($lista_clientes)):
