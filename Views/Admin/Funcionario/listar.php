<!--
    ...
    4. Modal e JavaScript inline devem ser separados
    
    TODO: Refatorar para:
    - Criar FuncionarioController::listar()
    - Mover toda lógica para o Controller
    - Esta view deve apenas exibir a lista fornecida pelo Controller
-->
<?php
