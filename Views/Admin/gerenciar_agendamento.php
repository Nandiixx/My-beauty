        ...
        <div class="dashboard-header">
            <div class="dashboard-header__greeting">
                ...
                <p>
                    ...
                    Visualize, crie ou cancele seus agendamentos
                </p>
            </div>
        </div>
                            ...
                            <div class="agendamento-item__header">
                                <div class="agendamento-item__content">
                                    ...
                                    <p class="agendamento-item__details">
                                        <strong><i data-lucide="user"></i> Profissional:</strong> <?php echo htmlspecialchars($a->profissional_nome ?? 'N/A'); ?>
                                    </p>
                                    <p class="agendamento-item__details">
                                        <strong><i data-lucide="calendar"></i> Data:</strong> <?php echo $data['data_completa']; ?>
                                        <strong class="ml-1"><i data-lucide="clock"></i> Horário:</strong> <?php echo $data['hora']; ?>
                                    </p>
                                </div>
                                <div class="agendamento-item__actions">
                                    ...
                                    <?php if ($a->status === 'AGENDADO'): ?>
                                        <div class="action-buttons">
                                            <a href="Index.php?acao=agendamento_editar&id=<?php echo $a->id; ?>" 
